...
# source: nuance/dialog/v1beta1/service-interface.proto
...
_CHANNELCONNECTORSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    input_type=nuance_dot_dialog_dot_v1beta1_dot_service__interface__messages__pb2._STARTREQUEST,
    output_type=nuance_dot_dialog_dot_v1beta1_dot_service__interface__messages__pb2._STARTRESPONSE,
  ...
  _descriptor.MethodDescriptor(
    ...
    index=1,
    containing_service=None,
    input_type=nuance_dot_dialog_dot_v1beta1_dot_service__interface__messages__pb2._EXECUTEREQUEST,
    output_type=nuance_dot_dialog_dot_v1beta1_dot_service__interface__messages__pb2._EXECUTERESPONSE,
  ...
  _descriptor.MethodDescriptor(
    ...
    index=2,
    containing_service=None,
    input_type=nuance_dot_dialog_dot_v1beta1_dot_service__interface__messages__pb2._STOPREQUEST,
    output_type=nuance_dot_dialog_dot_v1beta1_dot_service__interface__messages__pb2._STOPRESPONSE,
