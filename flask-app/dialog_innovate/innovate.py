...
def handle_data_response(stub, session_id, selector_dict, payload_dict, response):

    print("This got passed into handle_data_response function: ", response)
    response, call = execute_request(stub,                  #Then we send it back to the VA,
                        session_id=session_id, 
                        selector_dict=selector_dict,
                        payload_dict=payload_dict,
                        data_action=response
                    )
